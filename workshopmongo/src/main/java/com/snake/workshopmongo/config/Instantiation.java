package com.snake.workshopmongo.config;
...
import com.snake.workshopmongo.dto.AuthorDTO;
import com.snake.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa Viagem Linda!",sdf.parse("21/03/2018"),new AuthorDTO(alex));
